...
// export default function CustomerList({ datas, supplierUpdateMt }) {
...
//       dataIndex: 'vehicle-or-freezer-no',
//       key: 'vehicle-or-freezer-no',
//       editable: true,
//       width: 180,
//     },
//     {
...
//           <Form.Item className='mb-1' name='vehicle-or-freezer-no' label="Vehicle No / Freezer No" rules={[{ required: true, message: false }]}>
